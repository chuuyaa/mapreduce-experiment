...
public class mapreducePredictionTwitter800 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "100000");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/800k.txt");
