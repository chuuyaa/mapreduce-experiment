...
public class mapreducePredictionTwitter400 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "50000");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/400k.txt");
