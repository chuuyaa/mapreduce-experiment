...
public class mapreducePredictionTwitter1000 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "125000");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/1000k.txt");
