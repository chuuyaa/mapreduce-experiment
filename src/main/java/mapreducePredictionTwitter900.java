...
public class mapreducePredictionTwitter900 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "112500");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/900k.txt");
