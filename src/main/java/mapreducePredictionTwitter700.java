...
public class mapreducePredictionTwitter700 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "87500");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/700k.txt");
