...
public class mapreducePredictionTwitter500 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "62500");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/500k.txt");
