...
public class mapreducePredictionTwitter600 {
	...
	sc.hadoopConfiguration().set("mapred.max.split.size", "75000");
        ...
        JavaRDD<String> lines = sc.textFile("/user/hadoop/data/graphx/600k.txt");
